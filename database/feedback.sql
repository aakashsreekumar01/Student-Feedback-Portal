...
INSERT INTO `user` (`id`, `email`, `password`) VALUES (2, 'aakash@mail.com', 'aakash');
INSERT INTO `user` (`id`, `email`, `password`) VALUES (3, 'alvin@mail.com', 'alvin');
INSERT INTO `user` (`id`, `email`, `password`) VALUES (4, 'aashin@mail.com', 'aashin');