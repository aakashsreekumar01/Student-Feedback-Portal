      ...
      <form action="php/feedback.php" method="post" class="student-form">
        <div class="student-details">
          ...
          <select name="subject" id="subject">
            ...
            <option value="FLAT">Formal languages And Automata Theory</option>
            <option value="MSS">Management of Software System</option>
            ...
            <option value="DMS">Discrete Mathematical Structures</option>
            <option value="DS">Data Structures</option>
            <option value="LSD">Logic System Design</option>
            <option value="OOPJ">Object Oriented Programming Using JAVA</option>
